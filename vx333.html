...
─═ঊঈঊঈ═─╯
*/
define('API_KEY','634184170:AAGpw_f-EU1umnA89NbHH6wOtO6In9AXxWI');
//-----------------------------------------------------------------------------------------
//فانکشن MrPHPBot :
...
تابع 🔉 من❕فضلك 👣 :- @shahenm",
   ...
   [
['text'=>"فريق shahenm 🚸",'url'=>"https://telegram.me/teamiraq"]
  ],
    ]
    ])
    ]);
...
save("data/$chat_id/welcome.txt","اهلا عزيزي انرت المجموعة ⚡️ يرجى الالتزام 🐾 بالقوانين لكي ♻️ لا يتم طردك تابع :- @shahenm 🔉");
...
save("data/$chat_id/welcome.txt","اهلا عزيزي انرت المجموعة ⚡️ يرجى الالتزام 🐾 بالقوانين لكي ♻️ لا يتم طردك تابع :- @shahenm 🔉");
SendMessage($chat_id,"تم تفعيل ⚡️ البوت في المجموعة 🐾 لرؤية قوائم الحماية ♻️ ارسل الاوامر 🚸 تابع :- @shahenm ❕");
}
}
...
[اضغط هنا وتابع جديدنا ✔️](t.me/teamiraq)",
  'parse_mode'=>'MarkDown',
	]);
	}
 }
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تثبيت ☄ الرسالة بنجاح ⚡️ تابع :- @shahenm 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم طرد ☄ العضو بنجاح ⚡️ تابع :- @shahenm 🐾",
  'parse_mode'=>'MarkDown',
	]);
	}
}
...
save("data/$from_id/file.txt","sendtoall");
         MrPHPBot('sendmessage',[
        	'chat_id'=>$Dev,
        	'text'=>"ارسل ⚡️ النص ☄ الان 🌪 تابع @shahenm 📨",
		'parse_mode'=>'MarkDown',
    		]);
...
SendMessage($chat_id,"تم حفظ ☄ الترحيب بنجاح ⚡️ تابع :- @shahenm 🐾");
}
}
...
SendMessage($chat_id,"تم حفظ ☄ التكرار بنجاح ⚡️ تابع :- @shahenm 🐾");
}
else{
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text'=>"عذرا اختر ☄ من 1 الى 20 ⚡️ تابع :- @shahenm 🐾",
              ]);
}
}
}
...
SendMessage($chat_id,"تم تفعيل ☄ الترحيب بنجاح ⚡️ تابع :- @shahenm 🐾");
}
}
...
elseif (preg_match('/^(.*)([Bb][Oo][Tt])/s',$newchatmemberu) && $lockbots == "✔️" && $newchatmemberu != "SPDLBot") {
 MrPHPBot('sendMessage',[
 'chat_id'=>$chat_id,
 'text'=>'عذرا عزيزي ☄ ممنوع اضافة البوتات 🐾 هنا للاسف تم طرده ⚡️ تابع من فضلك :- @shahenm 🚸',
  'parse_mode'=>'HTML'
 ]);
 MrPHPBot('kickChatMember',[
 'chat_id'=>$chat_id,
...
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text' =>"تم حذف ☄ $num من الرسائل ⚡️ تابع :- @shahenm 🐾",
              ]);
}else{
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text'=>"عذرا اختر ☄ من 1 الى 100 ⚡️ تابع :- @shahenm 🐾",
              ]);
}
}
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تغيير ⚡️ اسم المجموعة ☄ بنجاح تابع :- @shahenm 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تغيير ⚡️ وصف المجموعة ☄ بنجاح تابع :- @shahenm 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم الغاء تثبيت ☄ الرسالة بنجاح ⚡️ تابع :- @shahenm 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"ارسل صورة ⚡️ للمجموعة الان ☄ تابع :- @shahenm 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  MrPHPBot('sendmessage',[
  'chat_id'=>$chat_id,
  'text'=>"   اعدادت ♻️ التكرار اختر ☄ من 1 الى 20 🐾 تابع عزيزي 🔉 @shahenm 🌪",
  'parse_mode'=>'MarkDown',
  'reply_markup'=>json_encode([
  'resize_keyboard'=>true,
  'inline_keyboard'=>[
...
}
{
   MrPHPBot('answerInlineQuery', [
        ...
        'results' => json_encode([[
            ...
            'title' => 'shahenm',
            'input_message_content' => ['parse_mode' => 'MarkDown', 'message_text' => "*Follow shahenm * ⚡️
...
*Channels📡 : •┇SHAH YEMEN┇•*"],
            'reply_markup' => [
                'inline_keyboard' => [
                    [
                        ['text' => "جديدنا", 'url' => 'https://telegram.me/shahenm']
                    ],
                    [
...
?>
n', 'message_text' =arse_mode' => 'MarkDown', 'message_text' => "*Follow shahenm * ⚡️
